...
- View your **activity log** (logins, tracked items)
- Manage your **NAICS codes** (add, edit, or remove)
- Set your **rating preferences** to match opportunities to your company’s strengths
