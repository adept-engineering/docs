...
Kontratar’s push notifications are supported on the following browsers for **desktop and Android**:
...
📌 **Note:** Due to iOS restrictions, all browsers on Apple devices use Safari’s WebKit engine, which **does not** support push notifications.