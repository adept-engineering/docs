...
- If you do not have an account, select the Sign Up option to be directed to the account registration page.
...
- Users can also generate proposals from SAM and Custom opportunities.
...
The Support icon at the bottom right of the screen provides quick access to help resources. From here, users can explore available features, view product documentation, or contact customer support for assistance.